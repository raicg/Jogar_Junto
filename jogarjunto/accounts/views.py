...
from .forms import CustomUserCreationForm, CustomPhotoForm, ChangeNameForm
...
def add_photo(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'user/edit_photo.html', {'form':form, 'image_path': image_path, })
...
def edit_name(request):
    if request.method == 'POST':
        ...
        form = ChangeNameForm()
        return render(request, 'user/edit_name.html', {'form':form,})
...
def edit_email(request):
    if request.method == 'POST':
        ...
        return render(request, 'user/edit_email.html', {'form':form,})
...
def edit_phone_number(request):
    if request.method == 'POST':
        ...
        return render(request, 'user/edit_phone_number.html', {'form':form,})
